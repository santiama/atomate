...
# from atomate.vasp.workflows.presets.core_add import wf_neb_spectra
...
class TestNudgedElasticBandWorkflow(unittest.TestCase):
    ...
    #     # Initial spec settings
    #     # cls.neb_config = {"neb_id": 0,
    #     #                   "path_id": 0,
    #     #                   "vasp_cmd": ">>vasp_cmd<<",
    ...
    #     #                   "endpoints_1": {},
    #     #                   "images": []}
    #     cls.wf = wf_neb_spectra(cls.structures, cls.neb_config)
    #
    # def setUp(self):
